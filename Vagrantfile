...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "ci" do |ci|
    ...
    ci.vm.box = "vagrant-teamcity/ci"
    ci.vm.box_url = "https://github.com/ladamalina/vagrant-teamcity/releases/download/v0.1/ci.box"

    ci.vm.provider "virtualbox" do |vb|
      vb.memory = "1024"
    end

    ci.vm.network "private_network", ip: "192.168.19.101"
